...
const UpdateConsumerBusiness = () => {
    ...
    async function OnSubmitUpdateBusinessProperty() {
        ...
        const postData = {
            ...
            BusinessId: parseInt(businessId.current.value),
        ...
        await fetch("http://13.127.74.103/api/Consumer/UpdateConsumerBusiness", {
            method: 'POST',
            headers: new Headers({
            ...
            .catch(error => {
                alert("Error Occured.Data Incorrect");
                ...
                <form ref={formRef}>
                    <table>
                        <tr>
                            <td>
                                ...
                                <input type="number" name="consumerId" className="inputs" style={{ marginLeft: "60px" }} ref={consumerId} placeholder="Consumer Id" required />
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td>
                                ...
                                <input type="text" name="email" className="inputs" style={{ marginLeft: "110px" }} ref={email} placeholder="Email" required />
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <label htmlFor="pan" >Pan</label>
                                <input type="text" name="pan" className="inputs" style={{ marginLeft: "122px" }} ref={pan} placeholder="Pan" required />
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td>
                                ...
                                <input type="number" name="businessId" className="inputs" style={{ marginLeft: "70px" }} ref={businessId} placeholder="Business Id" required />
                            </td>
                        </tr>
                        <tr>
                            <td>
                    ...
                    <Col className="buttons">
                        <FormGroup row>
                            ...
                            <Col sm={1}>
                                <button type="button" onClick={() => OnSubmitUpdateBusinessProperty()} className="btn btn-success">Submit</button>
                            </Col>
                            <Col sm={1}>
